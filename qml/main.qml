...
Window {
  ...
  Facebook {
    ...
    // if errors with build.xml occur, change the path to your Android SDK in vendor/facebook/local.properties or call "android update project --path . --target android-19" as described in the README here: https://github.com/vplayplugins/FacebookSample
